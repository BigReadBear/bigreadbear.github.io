      ...
      newConfirmedOver1000 = [];
        ...
        if (c.TotalDeaths > 50000) {
          newConfirmedOver1000.push({ 
            ...
            "TotalConfirmedPer100000" : Math.round(100000 * c.TotalConfirmed / populations[c.Slug]),
          });
        }
      }
      
      // order the array by TotalConfirmedPer100000 desc and store it in a new array
      totalConfirmedPer100000 = _.orderBy(newConfirmedOver1000, ['TotalConfirmedPer100000'], ['desc']);
